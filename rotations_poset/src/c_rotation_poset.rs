...
use crate::rotations_poset::RotationPoset;
...
impl CRotationPoset {
    pub fn from_rotation_poset(rp: &RotationPoset, profile: &PreferenceProfile) -> Self {
        let n = rp.n;
        
        let mut vec: Vec<CDependency> = Vec::new();
