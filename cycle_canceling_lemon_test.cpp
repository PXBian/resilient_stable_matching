...
int main(int argv, char** argc) {
    ...
    CycleCanceling<ListDigraph, int, int> mcf(graph);
    mcf.costMap(cost)
       .upperMap(capacity)
       .supplyMap(supply);
    ...
    if (result == CycleCanceling<ListDigraph, int, int>::OPTIMAL) {
    ...
    } else if (result == CycleCanceling<ListDigraph, int, int>::INFEASIBLE) {
        cout << "The problem is INFEASIBLE." << endl;
    } else if (result == CycleCanceling<ListDigraph, int, int>::UNBOUNDED) {
