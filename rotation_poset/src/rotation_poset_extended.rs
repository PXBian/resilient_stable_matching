...
use crate::algorithms::rotation_poset_generation_extended::build_rotation_poset_extended;
...
pub struct RotationPosetExtended {
...
impl RotationPosetExtended {
    ...
    pub fn from(profile: &PreferenceProfile) -> Self {
        build_rotation_poset_extended(profile)
    }
}
