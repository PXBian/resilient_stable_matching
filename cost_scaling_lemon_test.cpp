...
int main(int argv, char** argc) {
    ...
    CostScaling<ListDigraph, int, int> mcf(graph);
    mcf.costMap(cost)
       .upperMap(capacity)
       .supplyMap(supply);
    ...
    if (result == CostScaling<ListDigraph, int, int>::OPTIMAL) {
    ...
    } else if (result == CostScaling<ListDigraph, int, int>::INFEASIBLE) {
        cout << "The problem is INFEASIBLE." << endl;
    } else if (result == CostScaling<ListDigraph, int, int>::UNBOUNDED) {
